...
description: "Attach type-safe event listeners to any DOM element in React with automatic cleanup, CSS-selector delegation, and precise TypeScript event-type inference."
---
