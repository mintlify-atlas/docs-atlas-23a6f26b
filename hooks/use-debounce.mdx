---
title: "useDebounce: Debounced Reactive Value Hook for React"
sidebarTitle: "useDebounce"
description: "Delay a value update in React until input stops — great for search inputs, filters, and expensive computations on rapidly-changing state."
---
