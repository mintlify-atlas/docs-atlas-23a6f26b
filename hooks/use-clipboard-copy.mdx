---
title: "useClipboardCopy: Async Clipboard Copy Hook for React"
sidebarTitle: "useClipboardCopy"
description: "Copy text to the clipboard in React and track the result through a typed status — idle, success, or error. Status auto-resets after two seconds."
---
