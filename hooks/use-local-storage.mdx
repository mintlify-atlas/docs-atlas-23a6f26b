---
title: "useLocalStorage: Persistent localStorage State for React"
sidebarTitle: "useLocalStorage"
description: "Persist typed state in localStorage with JSON serialization, a useState-compatible API, automatic cross-tab sync via storage events, and error handling."
---
