---
title: "useDefault: State with Fallback Value for React"
sidebarTitle: "useDefault"
description: "Manage stateful values in React with an automatic fallback — whenever the value is set to null or undefined, the hook transparently substitutes a default."
---
